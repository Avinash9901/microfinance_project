...
Rectanglecustamized{
    ...
    signal loanviewbackClicked();
    signal gotoalldetailsofloancustomers();
    signal gotoloansanctionpage();
    property var loancustomers:loancustomerdetails.loancustomerAccount_numbers()
    ...
    Timer{
        ...
        repeat: false
        onTriggered: {
            error.title=qsTr("Swipe right and click for Customer details OR Swipe left and click for Loan")+MyTrans.mylngstring
            error.open();
        }
    }
    Rectanglecustamized{
        ...
        Popup{
            ...
            Column{
                ...
                Textcustamized{
                    ...
                    tfborder: "white"
                    tfcolor: "lightgray"
                    // rectext: qsTr("Enter agent password")+MyTrans.mylngstring
                ...
                Rectangle{
                    ...
                    MouseArea{
                        ...
                        onClicked: {
                            ...
                            var mypigmypassword= Agent2.loanpasswordsendtoqmlside();
                            console.log("my loan password======",mypigmypassword)
            ...
            Column{
                ...
                Row{
                    ...
                    Rectangle{
                        ...
                        color: "black"
                        // radius: viewpageid.height/1.1
                        width: viewpageid.width/6.1
                        radius: viewpageid.height/25
                        height: viewpageid.width/6.5
                        Text{
                            id:t24
                            text: "0"
        ...
        ListView {
            ...
            anchors.fill: parent
            model:loancustomers.length
            delegate:
                SwipeDelegate{
                property var mydata:model
                id:customerofpigmy
                text:loancustomers[index]
                width: viewpageid.width
                height: viewpageid.height/15
                    ...
                    Label{
                        ...
                        background: Rectangle{
                            ...
                            MouseArea{
                                anchors.fill: parent
                                onClicked: {
                                    var customer_name=loancustomerdetails.loancustomeracnumber(customerofpigmy.text)
                                    console.log("loancustomer name======",customerofpigmy.text)
                ...
                swipe.right: Row{
                    ...
                    Label{
                        id:movalable2
                        text: qsTr("Loan")+MyTrans.mylngstring
                        color: "white"
                        verticalAlignment: Label.AlignVCenter
                        horizontalAlignment: Label.AlignHCenter
                        padding: 12
                        ...
                        background: Rectangle{
                            ...
                            MouseArea{
                                anchors.fill: parent
                                onClicked: {
                                    var validationss=loancustomerdetails.loanCustomervalidation(customerofpigmy.text)
                                    console.log("pigmycustomer name======",customerofpigmy.text)
                                    if(validationss){
                                        gotoloansanctionpage();

                                        console.log("************details are validated************")
                                    }
                                    else{
                                        error.title=qsTr("Incorrect details")+MyTrans.mylngstring
                                        error.open();
