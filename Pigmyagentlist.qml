...
import Pigmyagent 1.0

Rectanglecustamized{
    rectanglewidth: parent.width
    rectangleheight: parent.height
    rectcolor: "orange"
    signal backtoadminpagefrompigmyagents();
    Rectanglecustamized{
        id:window3
        rectanglewidth: parent.width
        rectangleheight: parent.height
        ...
        TableView{
            ...
            TableViewColumn {title: qsTr("AgentWork")+MyTrans.mylngstring; role: "agentwork"; width:window3.width/2;movable:false;resizable:false}
            TableViewColumn {title: qsTr("AgentName")+MyTrans.mylngstring; role: "agentname"; width: window3.width/2;movable:false;resizable:false}
            TableViewColumn {title: qsTr("Mobile.no")+MyTrans.mylngstring; role: "mobilenumber"; width: window3.width/2;movable:false;resizable:false}
            TableViewColumn {title: qsTr("AgentBranch")+MyTrans.mylngstring; role: "branch"; width: window3.width/1.8;movable:false;resizable:false}
        }
    ...
    Image {
        ...
        MouseArea{
            anchors.fill: parent
            onClicked: {
                backtoadminpagefrompigmyagents();
            }
        }
    }
